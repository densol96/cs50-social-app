...
public record RegisterDto(
		@JsonProperty(value = "full-name") @NotBlank(message = "Full name must not be blank") @Pattern(regexp = "[A-Z][a-z]{1,15}( [A-Z][a-z]{1,15})?", message = "Full name must match theformat") String fullName,
